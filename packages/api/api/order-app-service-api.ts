...
/**
 * OrderAppServiceApi - axios parameter creator
 * @export
 */
export const OrderAppServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @param {string} id 
...
/**
 * OrderAppServiceApi - functional programming interface
 * @export
 */
export const OrderAppServiceApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = OrderAppServiceApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @param {string} id 
...
/**
 * OrderAppServiceApi - factory interface
 * @export
 */
export const OrderAppServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = OrderAppServiceApiFp(configuration)
    return {
        /**
         * 
         * @param {OrderAppServiceApiOrderAppServiceGetAppOrderRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        orderAppServiceGetAppOrder(requestParameters: OrderAppServiceApiOrderAppServiceGetAppOrderRequest, options?: AxiosRequestConfig): AxiosPromise<V1Order> {
            return localVarFp.orderAppServiceGetAppOrder(requestParameters.id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {OrderAppServiceApiOrderAppServiceListAppOrderRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        orderAppServiceListAppOrder(requestParameters: OrderAppServiceApiOrderAppServiceListAppOrderRequest = {}, options?: AxiosRequestConfig): AxiosPromise<V1ListOrderReply> {
        ...
        /**
         * 
         * @param {OrderAppServiceApiOrderAppServiceListAppOrder2Request} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        orderAppServiceListAppOrder2(requestParameters: OrderAppServiceApiOrderAppServiceListAppOrder2Request, options?: AxiosRequestConfig): AxiosPromise<V1ListOrderReply> {
            return localVarFp.orderAppServiceListAppOrder2(requestParameters.body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {OrderAppServiceApiOrderAppServiceRefundAppOrderRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        orderAppServiceRefundAppOrder(requestParameters: OrderAppServiceApiOrderAppServiceRefundAppOrderRequest, options?: AxiosRequestConfig): AxiosPromise<V1Order> {
...
/**
 * Request parameters for orderAppServiceGetAppOrder operation in OrderAppServiceApi.
 * @export
 * @interface OrderAppServiceApiOrderAppServiceGetAppOrderRequest
 */
export interface OrderAppServiceApiOrderAppServiceGetAppOrderRequest {
    /**
     * 
     * @type {string}
     * @memberof OrderAppServiceApiOrderAppServiceGetAppOrder
     */
    readonly id: string
}

/**
 * Request parameters for orderAppServiceListAppOrder operation in OrderAppServiceApi.
 * @export
 * @interface OrderAppServiceApiOrderAppServiceListAppOrderRequest
 */
export interface OrderAppServiceApiOrderAppServiceListAppOrderRequest {
    /**
     * 
     * @type {number}
     * @memberof OrderAppServiceApiOrderAppServiceListAppOrder
     */
...
/**
 * Request parameters for orderAppServiceListAppOrder2 operation in OrderAppServiceApi.
 * @export
 * @interface OrderAppServiceApiOrderAppServiceListAppOrder2Request
 */
export interface OrderAppServiceApiOrderAppServiceListAppOrder2Request {
    /**
     * 
     * @type {V1ListOrderRequest}
     * @memberof OrderAppServiceApiOrderAppServiceListAppOrder2
     */
    readonly body: V1ListOrderRequest
}

/**
 * Request parameters for orderAppServiceRefundAppOrder operation in OrderAppServiceApi.
 * @export
 * @interface OrderAppServiceApiOrderAppServiceRefundAppOrderRequest
 */
export interface OrderAppServiceApiOrderAppServiceRefundAppOrderRequest {
    /**
     * 
     * @type {string}
     * @memberof OrderAppServiceApiOrderAppServiceRefundAppOrder
     */
...
/**
 * OrderAppServiceApi - object-oriented interface
 * @export
 * @class OrderAppServiceApi
 * @extends {BaseAPI}
 */
export class OrderAppServiceApi extends BaseAPI {
    /**
     * 
     * @param {OrderAppServiceApiOrderAppServiceGetAppOrderRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof OrderAppServiceApi
     */
    public orderAppServiceGetAppOrder(requestParameters: OrderAppServiceApiOrderAppServiceGetAppOrderRequest, options?: AxiosRequestConfig) {
        return OrderAppServiceApiFp(this.configuration).orderAppServiceGetAppOrder(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrderAppServiceApi
     */
    public orderAppServiceListAppOrder(requestParameters: OrderAppServiceApiOrderAppServiceListAppOrderRequest = {}, options?: AxiosRequestConfig) {
        return OrderAppServiceApiFp(this.configuration).orderAppServiceListAppOrder(requestParameters.pageOffset, requestParameters.pageSize, requestParameters.search, requestParameters.sort, requestParameters.fields, requestParameters.filterId$eq, requestParameters.filterId$neq, requestParameters.filterId$contains, requestParameters.filterId$startsWith, requestParameters.filterId$nstartsWith, requestParameters.filterId$endsWith, requestParameters.filterId$nendsWith, requestParameters.filterId$in, requestParameters.filterId$nin, requestParameters.filterId$null, requestParameters.filterId$nnull, requestParameters.filterId$empty, requestParameters.filterId$nempty, requestParameters.filterId$like, requestParameters.filterName$eq, requestParameters.filterName$neq, requestParameters.filterName$contains, requestParameters.filterName$startsWith, requestParameters.filterName$nstartsWith, requestParameters.filterName$endsWith, requestParameters.filterName$nendsWith, requestParameters.filterName$in, requestParameters.filterName$nin, requestParameters.filterName$null, requestParameters.filterName$nnull, requestParameters.filterName$empty, requestParameters.filterName$nempty, requestParameters.filterName$like, requestParameters.filterCustomerId$eq, requestParameters.filterCustomerId$neq, requestParameters.filterCustomerId$contains, requestParameters.filterCustomerId$startsWith, requestParameters.filterCustomerId$nstartsWith, requestParameters.filterCustomerId$endsWith, requestParameters.filterCustomerId$nendsWith, requestParameters.filterCustomerId$in, requestParameters.filterCustomerId$nin, requestParameters.filterCustomerId$null, requestParameters.filterCustomerId$nnull, requestParameters.filterCustomerId$empty, requestParameters.filterCustomerId$nempty, requestParameters.filterCustomerId$like, requestParameters.afterPageToken, requestParameters.beforePageToken, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrderAppServiceApi
     */
    public orderAppServiceListAppOrder2(requestParameters: OrderAppServiceApiOrderAppServiceListAppOrder2Request, options?: AxiosRequestConfig) {
        return OrderAppServiceApiFp(this.configuration).orderAppServiceListAppOrder2(requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrderAppServiceApi
     */
    public orderAppServiceRefundAppOrder(requestParameters: OrderAppServiceApiOrderAppServiceRefundAppOrderRequest, options?: AxiosRequestConfig) {
        return OrderAppServiceApiFp(this.configuration).orderAppServiceRefundAppOrder(requestParameters.orderId, requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
}
