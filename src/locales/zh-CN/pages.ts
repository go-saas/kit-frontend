export default {
  ...
  'pages.login.accountLogin.errorMessage': '错误的凭证和密码',
  ...
  'pages.register.tips': '还没有账号？现在去注册',
  'pages.login.tips': '已有账号？现在去登录',
  'pages.register.account.tab': '用户名注册',
  'pages.register.phone.tab': '电话注册',
