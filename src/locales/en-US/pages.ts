export default {
  ...
  'pages.login.accountLogin.errorMessage': 'Incorrect identity/password',
  ...
  'pages.register.success': 'Register successfully!',
  'pages.register.title': 'Register',
  'pages.register.tips': 'Do not have an account? Go to register',
  'pages.login.tips': 'Already have an account? Go to login',
  'pages.register.account.tab': 'By username',
  'pages.register.phone.tab': 'By phone',
